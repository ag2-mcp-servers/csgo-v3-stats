...
#   timestamp: 2025-06-29T09:35:55+00:00
...
@app.get(
    ...
    tags=['team_and_venue_information'],
    security=[
        APIKeyHeader(name="Ocp-Apim-Subscription-Key"),
        APIKeyQuery(name="key"),
    ],
...
@app.get(
    ...
    tags=['competition_info', 'team_and_venue_information'],
    security=[
        APIKeyHeader(name="Ocp-Apim-Subscription-Key"),
        APIKeyQuery(name="key"),
    ],
...
@app.get(
    ...
    tags=['game_statistics', 'competition_info'],
    security=[
        APIKeyHeader(name="Ocp-Apim-Subscription-Key"),
        APIKeyQuery(name="key"),
    ],
...
@app.get(
    '/{format}/Players',
    description=""" Players """,
    tags=['player_data_retrieval', 'team_and_venue_information'],
    security=[
        APIKeyHeader(name="Ocp-Apim-Subscription-Key"),
        APIKeyQuery(name="key"),
    ],
...
@app.get(
    ...
    tags=['competition_info', 'game_statistics'],
    security=[
        APIKeyHeader(name="Ocp-Apim-Subscription-Key"),
        APIKeyQuery(name="key"),
    ],
...
@app.get(
    ...
    tags=['team_and_venue_information', 'competition_info'],
    security=[
        APIKeyHeader(name="Ocp-Apim-Subscription-Key"),
        APIKeyQuery(name="key"),
    ],
...
@app.get(
    '/{format}/Teams',
    description=""" Teams """,
    tags=['membership_management', 'team_and_venue_information'],
    security=[
        APIKeyHeader(name="Ocp-Apim-Subscription-Key"),
        APIKeyQuery(name="key"),
    ],
