...
class Leaderboard(BaseModel):
    ...
    AverageDamagePerRound: Optional[float] = None
    Clutch1v2s: Optional[float] = None
    Clutch1v3s: Optional[float] = None
    Clutch1v4s: Optional[float] = None
    Clutch1v5s: Optional[float] = None
    DateTime: Optional[str] = None
    Day: Optional[str] = None
    Deaths: Optional[float] = None
    EntryKills: Optional[float] = None
...
class Map(BaseModel):
    ...
    Leaderboards: Optional[List[Leaderboard]] = None
    Name: Optional[str] = None
